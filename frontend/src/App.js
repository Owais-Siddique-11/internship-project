      ...
      <div className="app-container">
        <Routes>
          ...
          <Route
            ...
            element={<ProtectedRoute element={<EditPage />} allowedRole="admin" />}
          />
          <Route
            path="/admin/services"
            element={<ProtectedRoute element={<Services />} allowedRole="admin" />}
          />
          <Route
            path="/admin/posts"
          ...
          <Route
            path="/user/services"
            element={<ProtectedRoute element={<UserServices />} allowedRole="user" />}
          />
          <Route
            path="/user/posts"
            element={<ProtectedRoute element={<UserPosts />} allowedRole="user" />}
          />
          <Route
            path="/user/contact"
            element={<ProtectedRoute element={<UserContact />} allowedRole="user" />}
          />
        </Routes>
      </div>
    </Router>
